...
<?php $_SESSION['filtro']['tipo'] = 'Horarios_Trabajo'; ?>
...
//Hora_Trabajo_L::obtenerTodos(), $o_Persona->getHorId()
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="modalTitle"><?php if ($o_Hora_Trabajo->getId() == null) echo _("Agregar Horario");
    ...
    <script type="text/javascript">
        ...
        function pagefunction() {
            ...
            $('#selHorarios').multiSelect({
                ...
                selectionHeader: "<legend><?php echo $o_Hora_Trabajo->getDetalle(); ?></legend></br><section><i class='icon-prepend icon-prepend-multi-select-search fa fa-search'></i><input type='text' class='search-input' autocomplete='off' placeholder='Buscar'></section>",
        ...
        function AgregarPersona(persona) {
            ...
            $.ajax({
                url: '<?php echo 'ajax/' . $Item_Name . '.html.php' ?>?tipo=insert&f_horario_tipo=<?php echo $T_Filtro_Horario_Tipo; ?>&id=<?php echo $o_Hora_Trabajo->getId(); ?>&personaID=' + persona,
                dataType: 'html',
                async: true,
        ...
        function EliminarPersona(persona) {
            ...
            $.ajax({
                url: '<?php echo 'ajax/' . $Item_Name . '.html.php' ?>?tipo=remove&f_horario_tipo=<?php echo $T_Filtro_Horario_Tipo; ?>&id=<?php echo $o_Hora_Trabajo->getId(); ?>&personaID=' + persona,
                dataType: 'html',
                async: true,
                timeout: 5000, //timeout de 5 segundos
                success: function (text) {
