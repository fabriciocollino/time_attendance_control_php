...
<div class="row">
    ...
    <div class="col-xs-8 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            ...
            <span>>
                <?php echo _('Horarios de Trabajo') ?>
			</span>
        </h1>
    </div>
    <!-- end col -->
    <?php if (Registry::getInstance()->Usuario->getTipoUsuarioObject()->getCodigo() >= 50) { ?>
        <div class="col-xs-4 col-sm-5 col-md-5 col-lg-8" id="sparkscontainer">
            <div id="sparks">
                <button class="btn btn-sm btn-primary" type="button" data-toggle="modal" data-backdrop="static"
                        data-target="#editar" data-type="view" data-lnk="ajax/horarios-editar.html.php">
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false"
                ...
                <header>
                    ...
                    <h2><?php echo _('Listado de Horarios') ?></h2>
                            ...
                            <?php if (!is_null($o_Listado)): ?>
                                ...
                                <?php foreach ($o_Listado as $key => $item): ?>
                                    <tr>
                                        ...
                                        <!-- HORARIO -->
                                        <td>
                                            <?php echo $item->getTextoDiasResumido($a_dias); ?>
                                        </td>

                                        <td>
                                            <?php echo Persona_L::obtenerPorHorariodeTrabajoCOUNT($item->getId(), HORARIO_NORMAL); ?>
                                        </td>
                                        ...
                                        <td style="white-space: nowrap;">
                                            <?php if (Registry::getInstance()->Usuario->getTipoUsuarioObject()->getCodigo() >= 50) { ?>
                                                ...
                                                <button    data-toggle="modal" data-backdrop="static" data-target="#editar"
                                                           ...
                                                           data-hor_tipo  =   "<?php echo HORARIO_NORMAL;    ?>"
                                                ...
                                                <button     data-toggle="modal" data-backdrop="static" data-target="#editar"
                                                            data-type="view"
                                                            data-lnk="ajax/horarios-personas.html.php"
                                                ...
                                                <button     data-toggle="modal" data-backdrop="static" data-target="#editar"
                                                            data-type="view"
                                                            data-lnk="ajax/horarios-editar.html.php"
                                                            data-id="<?php echo $item->getId(); ?>"
