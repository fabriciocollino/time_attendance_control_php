...
<?php $_SESSION['filtro']['tipo'] = 'Horarios_Multiples'; ?>
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false"
                ...
                <header>
                    ...
                    <h2><?php echo _('Listado de Horarios Múltiples') ?></h2>
                            ...
                            <?php if (!is_null($o_Listado)): ?>
                                ...
                                <?php foreach ($o_Listado as $key => $item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo Persona_L::obtenerPorHorariodeTrabajoCOUNT($item->getId(), HORARIO_MULTIPLE); ?>
                                        </td>
                                        ...
                                        <td style="white-space: nowrap;">
                                            ...
                                            <?php if (Registry::getInstance()->Usuario->getTipoUsuarioObject()->getCodigo() >= 50) { ?>
                                                ...
                                                <button data-toggle="modal" data-backdrop="static" data-target="#editar"
                                                        ...
                                                        data-hor_tipo      =   "<?php echo HORARIO_MULTIPLE;    ?>"
                                                ...
                                                <button data-toggle="modal" data-backdrop="static" data-target="#editar"
                                                        data-type="view"
                                                        data-lnk="ajax/horarios_multiples-personas.html.php"
