...
//Hora_Trabajo_L::obtenerTodos(), $o_Persona->getHorId()
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title"
            id="modalTitle"><?php if ($o_Horario_Rotativo->getId() == null) echo _("Agregar Horario");
    ...
    <script type="text/javascript">
        ...
        function pagefunction() {
            ...
            $('#selHorarios').multiSelect({
                ...
                selectionHeader: "<legend><?php echo $o_Horario_Rotativo->getDetalle(); ?></legend></br><section><i class='icon-prepend icon-prepend-multi-select-search fa fa-search'></i><input type='text' class='search-input' autocomplete='off' placeholder='Buscar'></section>",
        ...
        function AgregarPersona(persona) {
            ...
            $.ajax({
                url: '<?php echo 'ajax/horarios_rotativos.html.php' ?>?tipo=insert&f_horario_tipo=<?php echo $T_Filtro_Horario_Tipo; ?>&id=<?php echo $o_Horario_Rotativo->getId(); ?>&personaID=' + persona,
                dataType: 'html',
                async: true,
        ...
        function EliminarPersona(persona) {
            ...
            $.ajax({
                url: '<?php echo 'ajax/horarios_rotativos.html.php' ?>?tipo=remove&f_horario_tipo=<?php echo $T_Filtro_Horario_Tipo; ?>&id=<?php echo $o_Horario_Rotativo->getId(); ?>&personaID=' + persona,
                dataType: 'html',
                async: true,
                timeout: 5000, //timeout de 5 segundos
                success: function (text) {
        ...
        $('#editar').on('hidden.bs.modal', function () {
            ...
            loadURL('horarios_rotativos', $('#content'));
