...
<?php $_SESSION['filtro']['tipo'] = 'Horarios_Rotativos'; ?>
<?php require_once APP_PATH . '/controllers/horarios_rotativos.php'; ?>
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false"
                ...
                <header>
                    ...
                    <h2><?php echo _('Listado de Horarios Rotativos') ?></h2>
                            ...
                            <?php if (!is_null($o_Listado)): ?>
                                ...
                                <?php foreach ($o_Listado as $key => $item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo Persona_L::obtenerPorHorariodeTrabajoCOUNT($item->getId(), HORARIO_ROTATIVO); ?>
                                        </td>
                                        ...
                                        <td style="white-space: nowrap;">
                                            <?php if (Registry::getInstance()->Usuario->getTipoUsuarioObject()->getCodigo() >= 50) { ?>
                                                ...
                                                <button data-toggle="modal" data-backdrop="static" data-target="#editar"
                                                        ...
                                                        data-hor_tipo   =   "<?php echo HORARIO_ROTATIVO;    ?>"
                                                ...
                                                <button data-toggle="modal" data-backdrop="static" data-target="#editar"
                                                        data-type="view"
                                                        data-lnk="ajax/horarios_rotativos-personas.html.php"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        //$(document).on('click', 'a[data-type=delete], button[data-type=delete]', function (e) {
        //debugger;
