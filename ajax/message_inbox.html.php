                                ...
                                <?php if (!is_null($o_Messages)){ ?>
                                    ...
                                    <?php foreach ($o_Messages as $key => $item){
                                        ...
                                        <tr>
                                            ...
                                            <!-- EMISOR -->
                                            <td>
                                                <?php echo $o_sPersona -> getNombreCompleto(); ?>
                                            </td>
