        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false"
                ...
                <header>
                    ...
                    <h2>
                        <?php echo _('Mensajes Programados') ?>
                    </h2>
                </header>
                                ...
                                <?php if (!is_null($o_Messages)){ ?>
                                    ...
                                    <?php foreach ($o_Messages as $key => $item){
                                        ...
                                        <tr>
                                            ...
                                            <!-- RECEIVER -->
                                            <td>
                                                <?php echo $o_rPersona -> getNombreCompleto(); ?>
                                            </td>
                                            ...
                                            <!-- SCHEDULED DATE -->
                                            <td>
                                                <?php echo $item->getScheduledDate(); ?>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <button data-type           ="delete"
                                                        data-id             ="<?php echo $item->getId(); ?>"
                                                        data-lnk            ="ajax/message_scheduled.html.php"
        ...
        $('a[data-type=delete], button[data-type=delete]').click(function () {
            ...
            $.SmartMessageBox({
                ...
                if (ButtonPressed === "Si" || ButtonPressed === "Yes") {
                    ...
                    //loadURLwData('message_scheduled', $('#content'), {tipo: view_type, men_Id: data_id});
                }
