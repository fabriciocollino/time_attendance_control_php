...
<div class="modal-body" style="padding-top: 0;">
    ...
    <form class         ="smart-form"
          ...
          method        ="post"
          id            ="editar-form"
          action        ="<?php echo 'ajax/' . $Item_Name . '.html.php' ?>?tipo=<?php echo "edit&id=" . $o_Usuario->getId(); ?>">

        <!-- USER ID (HIDDEN)-->
        <?php $_usuId = Registry::getInstance()->Usuario->getId(); if ($_usuId != null) { ?>

            <input type="hidden" id="id" name="id" value="<?php echo $_usuId ?>"

        <?php }?>

        <!-- EMAIL, USER TYPE, PASSWORD, REAPEAT PASSWORD -->
        <fieldset>
        ...
        <!-- NAME, SURNAME, EMAIL, DNI , CELL PHONE-->
        <fieldset>
                ...
                <section class="col col-6">
                    <div class="thumbPersonaEditar">
                        ...
                        if ($o_Usuario->getImagen() == '') {
                            ...
                            echo '<img style="border-radius: 50%;" src="imagen.php?usu_id=' . $o_Usuario->getId() . '" id="finalImg" alt="me" >';
                        }
                        ?>
                    </div>
