...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="modalTitle"><?php if ($o_Grupo->getId()==null) echo _("Agregar Grupo"); else echo _("Editar Grupo"); ?></h4>
</div>
<div class="modal-body" style="padding-top: 0px;">

    <form class="smart-form" novalidate="novalidate" data-async method="post" id="editar-form" action="<?php echo 'ajax/'.$Item_Name.'.html.php' ?>?tipo=<?php if ($o_Grupo->getId()==null) echo "add"; else echo "edit&id=".$o_Grupo->getId(); ?>">
            ...
            <div class="row">
                <section class="col col-10" style="width: 100%">
                    <label class="input"> <i class="icon-prepend fa fa-users"></i>
                        <input type="text" name="detalle" placeholder="Nombre" value="<?php echo htmlentities($o_Grupo->getDetalle(), ENT_COMPAT, 'utf-8'); ?>">
                    </label>
                </section>
            </div>
        </fieldset>
