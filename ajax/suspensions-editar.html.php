...
<!-- MODAL CONTROLLER -->
<?php
require_once APP_PATH . '/controllers/' . basename(__FILE__, '-editar.html.php') . '.php';
?>
...
<div class="modal-header">
    ...
    <h4 class="modal-title"
        id="modalTitle"><?php if ($o_Suspension->getId() == 0) echo _("Agregar Suspensión"); else echo _("Editar Suspensión"); ?></h4>
</div>
...
<div class="modal-body" style="padding-top: 0;">
    ...
    <form class="smart-form" novalidate="novalidate"
          ...
          action="<?php echo 'ajax/' . $Item_Name . 's.html.php' ?>?tipo=<?php if ($o_Suspension->getId() == 0) echo "add"; else echo "edit&id=" . $o_Suspension->getId(); ?>">
                ...
                <section class="col col-10" style="width: 100%">
                    <label class="input"> <i class="icon-prepend fa fa-folder-o"></i>
                        <input type="text" name="motivo_Editar" placeholder="Motivo"
                               value="<?php echo htmlentities($o_Suspension->getMotivo(), ENT_COMPAT, 'utf-8'); ?>">
                    </label>
                </section>
            </div>
                ...
                <section class="col col-6"  >
                    <label class="select">
                        ...
                        <select name="selPersona_Editar" id="selPersona_Editar" style="padding-left: 32px;">
                            <?php echo HtmlHelper::array2htmloptions(Persona_L::obtenerTodos(0, 0, 0, 'per_Eliminada=0 and per_Excluir=0'), $o_Suspension->getPerId(), true, true, 'PersonayGrupoLicencia', _('Todas las Personas'));?>
                        </select>
                ...
                <section class="col col-6" id="selRol_Editar">
                    <label class="select"> <span class="icon-prepend fa fa-users"></span>
                        <select name="selGrupo_Editar" id="selGrupo_Editar" style="padding-left: 32px;">
                            <?php echo HtmlHelper::array2htmloptions(Grupo_L::obtenerTodos(), $o_Suspension->getGrupoId(), true, true, '', _('Seleccione un Grupo')); ?>
                        </select> <i></i> </label>
                </section>
                ...
                <section class="col col-6">
                    <label class="select"> <span class="icon-prepend fa fa-calendar"></span>
                        <select name="selTipo_Editar" id="selTipo_Editar" style="padding-left: 32px;">
                            <?php echo HtmlHelper::array2htmloptions($a_Suspensions_Tipos, $o_Suspension->getTipo(), false, false); ?>
                        </select> <i></i> </label>
                </section>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input class="form-control " style="padding-left: 5px;font-size: 12px;height: 31px;"
                                       ...
                                       value="<?php echo $o_Suspension->getFechaInicio('Y-m-d'); ?>">
                                <span id="btnDiaCompleto_Editar" class="input-group-addon"><i class="fa fa-calendar"
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input class="form-control " style="padding-left: 5px;font-size: 12px;height: 31px;"
                                       ...
                                       value="<?php echo $o_Suspension->getFechaInicio('Y-m-d'); ?>">
                                <span id="btnDesde_Editar" class="input-group-addon"><i class="fa fa-calendar"
                                                                                 style="cursor:pointer;line-height: 19px!important;padding-left: 5px;"></i></span>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input class="form-control " style="padding-left: 5px;font-size: 12px;height: 31px;"
                                       ...
                                       value="<?php echo $o_Suspension->getFechaFin('Y-m-d'); ?>">
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary" data-dismiss="modal" id="submit-editar">
        <?php if ($o_Suspension->getId() == 0) echo _("Agregar"); else echo _("Guardar"); ?>
    </button>
</div>
