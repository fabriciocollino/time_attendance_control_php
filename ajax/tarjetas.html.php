...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            ...
            <!-- PAGE HEADER -->
            <i class="fa-fw fa fa-credit-card-alt"></i>
                ...
                <div>
                    <div class="widget-body no-padding">
                        ...
                        <table id="dt_basic" class="table table-striped table-hover dataTable no-footer"
                            ...
                            <thead>
                            <tr>
                                <th><?php echo _('Tarjeta') ?></th>
                                <th><?php echo _('Nombre') ?></th>
                                <th><?php echo _('Primaria') ?></th>
                            ...
                            <?php if (!is_null($o_Listado)): ?>
                                ...
                                <?php foreach ($o_Listado as $key => $item): /* @var $item Tarjetas_O */ ?>

                                    <tr>
                                        <td><?php echo $item->getTarjeta().' '.$item->getMaskedNumber(); ?></td>
                                        <td><?php echo ($item->getDefault() ? "Si" : "No"); ?></td>
                                        <td><?php echo $item->getNombre(); ?></td>
                                        <td style="white-space: nowrap;">
                                            <button data-toggle="modal" data-backdrop="static" data-target="#editar"
                                                    data-type="view" data-lnk="ajax/tarjetas-editar.html.php"
                                            ...
                                            <button data-type="delete" data-id="<?php echo $item->getId(); ?>"
                                                    ...
                                                    class="btn btn-default btn-sm fa fa-trash-o fa-lg <?php echo ($item->getDefault() ? "disabled" : "") ?>"
                                                    style="line-height: .75em;"></button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
