						...
						<div class = "row">
							...
							<section class = "col col-2" style = "min-width: 180px;">
								<label class = "select">Estado</label> <label class = "select"> <span
											class = "icon-prepend fa fa-info"></span> <select name = "equipoid"
																							  id = "equipoid"
																							  style = "padding-left: 32px;">
                                        <?php echo HtmlHelper::array2htmloptions(Equipo_L::obtenerTodos(), $_SESSION['filtro']['equipoid'], true, true, 'Equipo', 'Todos los Equipos'); ?>
									</select> <i></i> </label>
							</section>
						</div>
					</fieldset>
